...
iioH = "C:\Users\logbo\DoAzimuthents\iio_matlab.h";
adH  = "C:\Users\logbo\DoAzimuthents\ad9361_matlab.h";
...
try
    ...
    tx_device = adi.FMComms5.Tx('uri','ip:192.168.0.101', ...
        'CenterFrequency', CenterFrequency, ...
    ...
    ctx = iio_create_ctx('ip:192.168.0.101');
    ad9361_mcs_sync(ctx);
