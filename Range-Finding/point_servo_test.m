...
% Purpose: Hardware demo for point_servo (tracking + prediction, no LiDAR).
...
fprintf('Step | az_in el_in | cmd_az cmd_el | hold_az hold_el\n');
...
for k = 1:N
    ...
    fprintf('%4d | %5.1f %5.1f | %6.1f %6.1f | %7d %7d\n', ...
        k, az_in, el_in, cmd_az, cmd_el, status.track.no_action_az, status.track.no_action_el);
    pause(dt);
end

% Plot source request, clamped target, and servo command.
