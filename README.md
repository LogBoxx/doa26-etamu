...
East Texas A&M University – Senior Design (ClCapstone of 2026)<br>

This repository doAzimuthents a hybrid tracking system that estimates **azimuth**, **elevation**, and **range** of a UAV (or any RF target source) using:<br>
...
We use **MUSIC (Multiple Signal ClCapstoneification)**, which:<br>
...
- Ground truth angle (even rough, using tape measure + compCapstone + known geometry)<br><br>
