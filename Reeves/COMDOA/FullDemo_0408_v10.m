% ======================================================================= %
% Script:   FullDemo_0402_v10
% Function: Version ten is ULA/ULA MUSIC w/ integrated lidar
...
try
    ...
    opts = struct();
    opts.el_offset = 25;      % tune if needed
    opts.max_move_az = 15;   % tune if needed
    opts.max_mo5e_el = 7;    % tune if needed
