function theta_est = music_algorithm_v2(X, D, k, ant_pos, theta_scan, phi_scan, ant_type)
% music_algorithm
%
% Implements the MUSIC (Multiple Signal ClCapstoneification) algorithm for DOA estimation.
%
% Inputs:
...
for i = 1:length(theta_scan)
    ...
    a_scan = create_uca_steering_vector_v2(theta_scan(i), phi_scan, k, ant_pos);

    % Project onto the noise subspace
    denominator = a_scan' * (En * En') * a_scan; % periods
